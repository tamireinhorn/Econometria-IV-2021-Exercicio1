...
A function to compute daily variables of interest will be created, and in a following code it will be applied to our list of stocks:
...
#Seeing that the handcrafted example works, it's time to make it into a proper function to create our daily dataframes
