...
rv <- clean_data %>% 
  ...
  summarise(RV = sum(r_cc^2, na.rm = T), VOL = sum(Volume)) %>% #for each stock and day we obtain two variables: RV, which is the accumulated squared closed-to-closed returns, and VOL, which sums the volumes of the minutes of that day. 
