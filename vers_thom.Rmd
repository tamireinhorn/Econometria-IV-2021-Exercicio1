...
#We can group RV_tssible by stock and create an object FitHAR <- HAREstimate(RM = RV, periods = c(1,5,22)) to each group using group_map()

#extract the estimated coefficients:
#coef(FitHAR)

#simulate a theoretical series using estimated coefficients
#sim <- HARSimulate(len=1500, periods = c(1, 5, 22),
#coef = coef(FitHAR), errorTermSD = 0.001)

#generate ACF using simulation above
# ACF(sim, lag_max = definir) %>% autoplot() + theme_bw() + labs(x = 'Lags', y = '')
