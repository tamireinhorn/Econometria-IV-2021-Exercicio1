...
for(i in 1:2){
    print('days')
    print(i)
    print('Beg variable for this day is')
    beg <- i + (month - 1) ##Just to clear notation, I wanted to create this variable for the interval's beggining.
    print(beg)
   ...
   ## other_window <- wide_other_stock_df [(beg):(window_size - 1 +beg ),]
    ...
    ddf <- data.frame(Date = day_list, RVm = RV_m)
  }
```